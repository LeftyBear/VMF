...
| P2-17 | Evaluate a draft-only CHANGELOG helper derived from P2-04-E. | P2 | A bounded helper may reduce manual transcription from release-note draft fields, but `CHANGELOG.md` remains manually curated. | `Publisher_P2-17_CHANGELOGDraftHelperEvaluation.md`; existing P2-04 allow-listed release-note draft boundary. | Potential future documentation-drift reduction without changing release, package, Google, OAuth, vendor-clearance, or Avast gates. | Design complete / implementation decision pending. |
